...
const Home = () => {
    ...
    return (
        <div className={css.wrapper}>
            ...
            <img  src="https://thumbs.dreamstime.com/b/two-people-man-woman-character-talking-smart-phone-online-communication-email-message-concept-video-call-business-chat-242889380.jpg" alt="" width="700" height="700"></img>
</div>
